...
public class CompoundColors {
    ...
    // Holm gives the two sides of a conversation different colours — a neutral
    // surface for what was received, the brand periwinkle for what was sent —
    // rather than Compound's matching greys.
    public let _bgBubbleIncoming = Color(UIColor { $0.isLight
        ? UIColor(red: 0.925, green: 0.929, blue: 0.925, alpha: 1)
        : UIColor(red: 0.086, green: 0.110, blue: 0.114, alpha: 1) })
    /// This token is a placeholder and hasn't been finalised.
    @available(iOS, deprecated: 100000.0, message: "This token should be generated by now.")
    public let _bgBubbleOutgoing = Color(UIColor { $0.isLight
        ? UIColor(red: 0.804, green: 0.937, blue: 0.925, alpha: 1)
        : UIColor(red: 0.071, green: 0.278, blue: 0.267, alpha: 1) })
    /// This token is a placeholder and hasn't been finalised.
    @available(iOS, deprecated: 100000.0, message: "This token should be generated by now.")
